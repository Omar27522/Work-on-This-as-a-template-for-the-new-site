...
$titulos = [
    ...
    'El Buen Dios siempre está contigo',
...
$navegar = [
    ...
    'prioridad' => '<span class="browse">Recuerda</span> priorizar tu seguridad y privacidad en línea. Ten cuidado con las estafas, los intentos de phishing y otros tipos de fraude en línea. Utiliza contraseñas fuertes y asegúrate de que tu información personal esté protegida.',
    ...
    'conCuidado' => '<span class="browse">Sé</span> cauteloso con la información falsa o las "noticias falsas" que pueden circular en línea. Verifica la información de fuentes confiables y evita compartir información no verificada que podría ser engañosa o dañina.',
    ...
    'busca' => '<span class="browse">Busca</span> recursos y comunidades católicas de buena reputación en línea, como sitios web de noticias católicas, blogs, podcasts y grupos de redes sociales. Estos recursos pueden proporcionar información valiosa y apoyo para tu viaje de fe.',
    ...
    'recuerda' => '<span class="browse">Recuerda</span> respetar las leyes de copyright y evitar piratear o compartir ilegalmente material protegido por derechos de autor en línea.',
    ...
    'tiempoEnLinea' => '<span class="browse">Sé</span> consciente del tiempo que pasas en línea y toma descansos según sea necesario. Es importante mantener un equilibrio saludable entre tus actividades en línea y otros aspectos de tu vida, como el trabajo, las relaciones y las actividades de ocio.',
    ...
    'finalmente' => 'Finalmente, sé consciente del potencial de la adicción en línea y toma medidas para prevenirla. Esto puede incluir establecer límites en el uso de internet, practicar mindfulness y buscar apoyo si es necesario. Recuerda que tu relación con Dios y tu comunidad de fe siempre deben tener prioridad sobre tus <span class="browse">actividades en línea</span>.',

    'conclusion' => 'Un último punto a considerar es siempre abordar internet con una mente abierta y un espíritu de discernimiento. Si bien hay mucho bueno que se puede encontrar en línea, también hay muchos desafíos y peligros de los que hay que ser consciente. Es importante permanecer vigilante y usar tu fe católica como guía para navegar en el mundo en línea. En última instancia, tu relación con Dios y tu compromiso con las enseñanzas católicas deben ser la base de tus actividades en línea y deben guiarte en todo lo que hagas.'
  ];

$navegarS = [
    'Acércate a internet con humildad y disposición de aprender. Aunque tengas un profundo entendimiento de las enseñanzas y tradiciones católicas, el mundo en línea puede presentar desafíos nuevos y únicos que pueden requerir un enfoque o perspectiva diferente.',
    'Recuerda que internet es un reflejo del mundo más amplio y puede ser una fuente de bien y de mal. <span class="browse">Aunque hay mucho bueno que se puede encontrar en línea, también hay muchos peligros y tentaciones de los que hay que estar al tanto.</span> Es importante ejercer discernimiento y confiar en tu fe católica como guía para navegar por el mundo en línea.',
    ...
    'Recuerda que internet no es un reemplazo para las interacciones cara a cara y la comunidad.',
...
$siempreEsDios = [
    ...
    'Recuerda que internet puede ser una poderosa herramienta para compartir el mensaje del Evangelio con los demás. Utiliza tu presencia en línea para difundir la palabra de Dios e inspirar a otros a vivir vidas virtuosas de acuerdo con las enseñanzas católicas.',
    ...
    'Recuerda que internet puede ser una fuente de distracción y tentación, y que es importante mantener un equilibrio saludable entre tus actividades en línea y tu bienestar físico, emocional y espiritual. Establece límites para tus actividades en línea y haz tiempo para la comunidad física e interacciones cara a cara con los demás.',
...
$batalla = [
    'El concepto de la batalla constante entre el bien y el mal es un tema común en muchas religiones alrededor del mundo. Es la idea de que existe una lucha continua entre las fuerzas de la luz y la oscuridad, o entre las energías positivas y negativas, que afecta todos los aspectos de nuestras vidas y el mundo que nos rodea.',
...
$responsibility = [
    ...
    'En última instancia, nuestra responsabilidad con otros seres vivos es una que requiere atención y cuidado continuos, y una voluntad de participar en los complejos problemas éticos y prácticos involucrados. Al trabajar juntos para promover una gestión ética y responsable del mundo natural, podemos ayudar a garantizar un futuro sostenible y próspero para todos los seres vivos.'
  ];
?>