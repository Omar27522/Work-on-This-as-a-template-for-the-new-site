...
$introx = ['Una copia de seguridad es una copia de datos que se puede usar para restaurar los datos originales en caso de que se pierdan o dañen.',
          ...
          'completo' => 'Estas copias de seguridad incluyen una copia completa de todos los datos. Las copias de seguridad completas pueden llevar mucho tiempo crear y restaurar, pero proporcionan un registro completo de todos los datos y son útiles para la recuperación de desastres.',

          'incremental' => 'Estas copias de seguridad solo incluyen los cambios realizados desde la última copia de seguridad. Las copias de seguridad incrementales son más rápidas de crear y restaurar que las copias de seguridad completas, pero pueden no proporcionar tanta protección en caso de un desastre.',

          'diferencial' => 'Estas copias de seguridad incluyen todos los cambios realizados desde la última copia de seguridad completa. Las copias de seguridad diferenciales son similares a las copias de seguridad incrementales en que solo incluyen cambios, pero proporcionan más protección que las copias de seguridad incrementales porque incluyen todos los cambios realizados desde la última copia de seguridad completa.',

          'espejo' => 'Estas copias de seguridad crean una copia exacta de los datos que se están respaldando. Las copias de seguridad espejo son útiles para restaurar rápidamente los datos, pero pueden no ser tan completas como otros tipos de copias de seguridad.',

          'outro' => 'Generalmente se recomienda crear copias de seguridad de forma regular y almacenarlas en un lugar seguro, como un disco duro externo o un servicio de almacenamiento basado en la nube. Esto garantizará que tenga acceso a sus datos en caso de emergencia.',

          'en-sitio' => ['la copia de seguridad es fácil de configurar, los datos son convenientes para acceder y no se requiere conexión a Internet para hacer copias de seguridad o restaurar datos.',
          ...
          'fuera-de-sitio' => ['la copia de seguridad consiste esencialmente en guardar los datos en una unidad de memoria u otro dispositivo,
          ...
          'nube' => ['la copia de seguridad requiere una conexión a Internet para acceder al espacio en la nube
                                donde se almacenan los datos, es simple y se puede acceder a los datos desde cualquier lugar.',

                                'Almacenar datos en Internet, de esa manera, si necesitara un archivo, simplemente puede iniciar sesión y recuperar el archivo de su cuenta de copia de seguridad en línea.
                                hay servicios que hacen copias de seguridad de sus datos automáticamente en línea, la mayoría de los gratuitos tienen espacio y capacidades limitadas.']
        ];
?>