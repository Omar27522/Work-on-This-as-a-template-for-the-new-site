    ...
    <main class="main">
        <header class="header">
            ...
            <div class="header_resize">
                <div class="logo">
                    <h1>
                      <a href="../"><span>LAtinos</span>PC.com<small> "PC" es por Computadora Personal</small></a>
                    </h1>
                </div>
                <div class="clr"></div>
            </div>
        ...
        <div class="hbg"><!-- HBG -->
            <div class="hbg_resize">
                <nav class="menu_nav" id="scroll"><!-- nav bar -->
                    <ul>
                        <li class="<?= $js="current dropdown"; ?>"><a class="dropbtn" onclick="myFunction()">Cristo Jesus</a><!-- Menu Barra Navegación -->
                            <div class="dropdown-content" id="myDropdown">
                                <a href="<?= $directoryPath ?>español/?Jesus"style="display: inline;background-image:none;background-color:#f9f9f9;">
                                    <?php // este es el menu desplegable
                                      ...
                                      for($i=0; $i<1; $i++) {  shuffle($pictures);echo $pictures[$i];}
                                ...
                                <div class="rtl" style="padding-top: 30px;padding-right:20px;">
                                    <a href="<?= $directoryPath ?>español/?respaldos">Respaldos</a>
                                ...
                                <a href="#Funciona !!!"
                                    style="float: right;display: inline;background-image:none;background-color:#f9f9f9;"><img
                                        src="<?= $directoryPath; ?>include/_images/100.webp" class="rtl image"
                                        style="translate: -40% -50%; border-radius: 110%;" alt="CPUimage"
                                        width="200px" />
                                </a>
                        ...
                        <li class="<?= empty($casa) ? ($casa = 'current') : ($casa = 'active'); ?>">
                            <a href="<?=$directoryPath ?>español">Inicio</a>
                        </li>
                        ...
                        <li class="<?= empty($acerca) ? ($acerca = 'current') : ($acerca = 'active');?>">
                            <a href="<?= $directoryPath ?>español/acerca/">Acerca de</a>
                        </li>

                        <li class="<?= empty($hardware) ? ($hardware = 'current') : ($hardware = 'active');?>">
                            <a href="<?= $directoryPath ?>español/hardware/">Hardware </a>
                        </li>

                        <li class="<?= empty($software) ? ($software = 'current') : ($software = 'active');?>">
                            <a href="<?= $directoryPath ?>español/software/">Software </a>
                        </li>

                        <li class="<?= empty($contacto) ? ($contacto = 'current') : ($contacto = 'active');?>">
                            <a href="<?= $directoryPath ?>español/contacto/">Contacto</a>
                        </li>

                        <li class="<?= empty($critica) ? ($critica = 'current') : ($critica = 'active');?>">
                            <a href="<?= $directoryPath ?>español/critica/">Reseñas</a>
                        </li>
                        <li class="<?= $phone="current"; ?>">
                          <a href="tel:9092767214" style="translate: 705px -85px;color: #fff;font-size: 30px;background-color: rgba(51, 170, 51, .384);">
                            909-276-7214
                          </a>
                        </li>
                    </ul>
        ...
        <div class="content">
            ...
            <div class="content_resize">
                <!-- Content Resize -->
                <?php content(); //Este es el contenido principal de la pagina.?>
            </div>
            <!--^^ Content Resize ^^-->
        </div>
        <!--^^ Content ^^-->
        ...
        <div class="fbg">
            ...
            <div class="fbg_resize">
                ...
                <div class="col c3">
                    ...
                    <p>
                      Una empresa con años de experiencia, brindando a las personas
        ...
        <footer class="links">
            <nav class="footer-links">
                ...
                <a href="<?= $directoryPath ?>español/software/programs" class="link"><span
                        class="link">Programas</span></a>
                <a href="<?= $directoryPath ?>español/hardware/" class="link"><span class="link">Anatomía Hw</span></a>
                <a href="<?= $directoryPath ?>español/hardware/notebooks" class="link"><span
                        class="link">Notebooks</span></a>
                <a href="<?= $directoryPath ?>español/hardware/cables" class="link"><span class="link">Cables</span></a>
                <a href="<?= $directoryPath ?>español/software/websites" class="link"><span class="link">Paginas
                        Web</span></a>
                <a href="<?= $directoryPath ?>español/software/passwords" class="link"><span
                        class="link">contraseñas</span></a>
        ...
        <div class="footer">
            <div class="footer_resize">
                <p class="lf">
                  © Copyright <a href="http://latinospc.com">LAtinosPC.com</a>.
                </p>
                <p class="rf">
                  Layout by Atomic <a href="http://www.atomicwebsitetemplates.com/">WebsiteTemplates</a>
                </p>
            </div>
        </div>
        <!--^^ Footer Bar ^^-->
