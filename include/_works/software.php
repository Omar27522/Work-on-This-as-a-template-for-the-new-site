<article class="fullbar">
    ...
    <section class="hero3" id="software">
        ...
        <div class="container">
            <a href="#title"><img src="https://latinospc.com/images/programs/code.jpg" width="263" height="400"
            ...
            <aside class="colms2">
                ...
                <a href="?malwarecleaner#ps2" id="refresh"><button type="button" class="bttn">Malware
                        Cleaner</button></a>
            ...
            <h3><a href="#title" class="rm" title="Programs">Read more</a></h3>
        </div>
    </section>
</article>
<!--Full Bar -->
...
<article class="fullbar">
    <br />
    <a href="#software" id="title" class="sub_title">When it comes to choosing the right software for the job, there are
        many factors to
        consider.</a>
    <div class="spacer">
        <hr />
        ...
        <section tabindex="0" class="selection">
            ...
            <p>
                <strong>Try before you buy:</strong> Many software vendors offer free trial versions of their software,
                    so you can test the software out before you make a purchase.</p>
