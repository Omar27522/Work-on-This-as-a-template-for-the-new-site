...
$descriptions = [//up to 52 word descriptions
...
$descripciones = [
    'av' => 'Un programa antivirus en sí mismo está creado para ayudar a la computadora a protegerse de los virus. Las mejores soluciones antivirus son aquellas que se mantienen actualizadas con las amenazas que intentan dañar la computadora (PC). Además, las mejores soluciones antivirus son simples, cuestan menos de lo que se imagina y brindan tranquilidad.',
    'mlwc' => 'El malware, archivos dañinos que infectan computadoras, puede encontrarse en correos no deseados, correos electrónicos, unidades infectadas o software empaquetado. A menudo disfrazado como software inofensivo, el malware roba datos y puede causar daños irreparables. Para prevenir infecciones, utiliza soluciones antivirus pagas o gratuitas que ofrezcan protección en tiempo real y escaneo en segundo plano.',
