...
<article class="container">
   <section class="tablet">
     ...
     <p>
       <a rel="example_group" href="../images/hardware/hw/tablets/sci-fi-tablet.jpg" title="Sci Fi Tablet"><img src="../images/hardware/hw/tablets/sci-fi-tablet.webp"  height="100px" alt="Sci-Fi device" class="fl"></a>
       ...
       <a rel="example_group" href="../images/hardware/hw/tablets/dynabook.jpg" title="https://www.computerhistory.org/revolution/mobile-computing/18/315"><img src="../images/hardware/hw/tablets/dynabook.webp" height="100px" width="40%" alt="Alan Kay's Dynabook" class="rtl"></a>
   ...
   <section class="tablet">
     ...
     <p>
       <a rel="example_group" href="../images/hardware/hw/tablets/gridpad.jpg" title="GRiDPad"><img src="../images/hardware/hw/tablets/gridpad.webp" alt="GRiDPad" height="100px" title="GRiDPad" class="fl"></a>
       ...
       <a rel="example_group" href="../images/hardware/hw/tablets/windows_pen.jpg" title="Windows Pen"><img src="../images/hardware/hw/tablets/windows_pen.webp" alt="Windows Pen" height="100px" class="rtl"></a>
...
<article class="container">
   <section>
      ...
      <a rel="example_group" href="../images/hardware/hw/tablets/ipad1stgen.jpg"title="1st Gen iPad"><img src="../images/hardware/hw/tablets/ipad1stgen.jpg" alt="image" height="100px" title="1st Gen iPad" class="fl"></a>
   ...
   <section>
      ...
      <p>
         <a rel="example_group" href="../images/hardware/hw/tablets/friends.jpg"><img src="../images/hardware/hw/tablets/friends.webp" alt="image" height="100px" alt="Tablet Friends" class="rtl"style="margin-left: 1.5px;"></a>
...
<article class="article">
         ...
         <figure><a rel="example_group" href="../images/hardware/hw/tablets/ipad.jpg" title="https://unsplash.com/photos/a-tablet-computer-sitting-on-top-of-a-table-p1B6G7acvZ8"><img src="../images/hardware/hw/tablets/ipad.webp"alt="Ipad Series"></a><figcaption>Apple Ipad.</figcaption></figure>
         ...
         <article class="container">
            <section class="tablet">
               <p>
                  ...
                  <a rel="example_group" href="../images/hardware/hw/tablets/yoga.jpg" title="Lenovo Yoga Tablet 2 Pro 2014"><img src="../images/hardware/hw/tablets/yoga.webp" alt="Yoga Tablet 2 Pro" width="90px"class="fl"></a>With its unique cylindrical battery and built-in projector, this tablet aimed for multimedia excellence and stood out from the crowd.
               </p>
            </section>
            <section class="tablet">
               <p>
                  ...
                  <a rel="example_group" href="../images/hardware/hw/tablets/shield.jpg" title="Nvidia SHIELD Tablet"><img src="../images/hardware/hw/tablets/shield.webp" alt="SHIELD Tablet"width="90px"class="rtl"></a>Aimed at gamers, the SHIELD Tablet featured powerful hardware and game streaming capabilities, making it a hit among mobile gaming enthusiasts.
               </p>
            </section>
         </article>
         <article class="container">
            <section class="tablet">
               <p>
                  ...
                  <a rel="example_group" href="../images/hardware/hw/tablets/venue8.jpg" title="Dell Venue 8 7000"><img src="../images/hardware/hw/tablets/venue8.webp" alt="Venue 8 7000" width="90px" class="rtl"></a>Known for its innovative design and Intel RealSense depth-sensing camera, this tablet stood out with unique features and capabilities.
               </p>
            </section>
            <section class="tablet">
               <p>
                  <strong><a href="https://www.sony.com/en/SonyInfo/design/gallery/XperiaTabletZ/">Sony Xperia Tablet Z</a> (2013):</strong>
                  <a rel="example_group" href="../images/hardware/hw/tablets/xperiatabletz.jpg" title="Sony Xperia Tablet Z"><img src="../images/hardware/hw/tablets/xperiatabletz.webp" alt="Xperia Tablet Z" width="90px"class="fl"></a>Showcasing Sony's commitment to multimedia features, the Xperia Tablet Z impressed with its slim and waterproof design.
               </p>
            </section>
         </article>
         <article class="container">
      ...
      <details><summary class="card2">🖥️ Microsoft Surface Series</summary>
         ...
         <figure><a rel="example_group" href="../images/hardware/hw/tablets/surface.jpg" title="Microsoft Surface"><img src="../images/hardware/hw/tablets/surface.webp" alt="Surface Series"></a><figcaption>Microsoft Surface Series</figcaption></figure>
         <article class="container">
         <section class="tablet">
               <p>
      ...
      <details><summary class="card2">📱 Samsung Galaxy Tab Series</summary>
         <article class="container">
            ...
            <section class="container"><figure><a rel="example_group" href="../images/hardware/hw/tablets/galaxytab.jpg" title="https://www.samsung.com/us/mobile/tablets/galaxy-tab-s/"><img src="../images/hardware/hw/tablets/galaxytab.webp" alt="Galaxy Tab Series"></a><figcaption>Samsung Galaxy Tab S9 Series</figcaption></figure>
         </section>
         </details>
      <details><summary class="card2">📚 Amazon Fire Tablet</summary>
         ...
         <section class="container">
            <figure><a rel="example_group" href="../images/hardware/hw/tablets/amazonfire.jpg" title="Amazon Fire Tablet lineup"><img src="../images/hardware/hw/tablets/amazonfire.webp"alt="Amazon Fire Tablet lineup"></a><figcaption>Amazon Fire Tablet Lineup.</figcaption></figure>
         </section>
         <article class="container">
            <section class="tablet">
               <p>
      ...
      <details><summary class="card2">🤖 Google Tablets</summary>
         ...
         <section class="container">
            <figure><a rel="example_group" href="../images/hardware/hw/tablets/googletablet.jpg" title="Pixel Tablet 2023"><img src="../images/hardware/hw/tablets/googletablet.webp"alt="Google Pixel Tablet"></a><figcaption>Google Pixel Tablet.</figcaption></figure>
         </section>
         <article class="container">
            <section class="tablet">
               <p>
...
<a rel="example_group" href="../images/hardware/hw/tablets/arvr.jpg"title="AR VR Tablets" class="poss"><img src="../images/hardware/hw/tablets/arvr.webp" alt="AR VR Tablets" width="100px"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a rel="example_group" href="../images/hardware/hw/tablets/futuretablet.jpg"title="Future Tablets"><img src="../images/hardware/hw/tablets/futuretablet.webp" alt="Future of Tablets"  width="100px"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a rel="example_group" href="../images/hardware/hw/tablets/futuretablet2.jpg"title="Future of Tablets" class="poss"><img src="../images/hardware/hw/tablets/futuretablet2.webp" alt="Future of tablets" width="100px"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a rel="example_group" href="../images/hardware/hw/tablets/futuretablet3.jpg"title="Tablets" class="poss"><img src="../images/hardware/hw/tablets/futuretablet3.webp" alt="Tablets" width="100px"></a>
...
<article class="article"><section>
    <!-- (-.-)Zzz...--|c[_]|--☁【ツ】☁--|c[_]|--\(^-^)/--|c[_]|--(╯°□°）╯ ︵ ┻━┻ `ღ´ -->
    <p class="container tablet"><a rel="example_group" href="../images/hardware/hw/tablets/usa.jpg"><img src="../images/hardware/hw/tablets/usa.webp" alt="Tablet Market" class="fl"></a>
   ...
   <p class="container tablet"><a rel="example_group" href="../images/hardware/hw/tablets/america.jpg"><img src="../images/hardware/hw/tablets/america.webp" alt="Tablet Market" class="rtl"></a>
   ...
   <p class="container tablet"><a rel="example_group" href="../images/hardware/hw/tablets/world.jpg"><img src="../images/hardware/hw/tablets/world.webp" alt="Tablet Market" class="fl"></a>
