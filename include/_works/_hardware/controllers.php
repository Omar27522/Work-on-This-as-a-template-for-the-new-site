<style>
    .modern_list {
    background-image: url("../../images/hardware/hw/controllers/texture.webp"); /* Replace with your texture image path */
...
<a rel="example_group" href="../images/hardware/hw/controllers/orchestra.jpg" title="Controllers Orchestra" style="float:left;">
	<img src="../images/hardware/hw/controllers/orchestra.webp" alt="Orchestra" class="fl">
</a>
...
<img src="../images/hardware/hw/controllers/orchestra.webp" class="push">
...
<div class="spacer"></div>
<p class="modern_list ml2">Load Balancing:</p><ul class="segment colms"><img src="../images/hardware/hw/controllers/orchestra.webp" class="push">
...
<div class="spacer"></div>
<p class="modern_list ml2">Cooling System Control:</p><ul class="segment colms"><img src="../images/hardware/hw/controllers/orchestra.webp" class="push">
	<img src="../images/hardware/hw/controllers/orchestra.webp" class="push">
...
<p class="modern_list ml2">Remote Monitoring and Control:</p><ul class="segment colms">
	...
	<a rel="example_group" href="../images/hardware/hw/controllers/orchestra.jpg"><img src="../images/hardware/hw/controllers/orchestra.webp" class="push"></a>
