...
.tnk:hover {
    background: url(../images/blue_rectangle.png) repeat-x top;
    transition: all 0.5s ease-in-out;
}

.tnk:focus {
    background: url(../images/blue_rectangle.png) repeat-y right;
    transition: all 0.3s ease-in-out;
}
...
<article class="fullbar">
    ...
    <h3>
        ...
        <div class="container"><span class="center" style="width: fit-content; padding: 20px;" id="trends">
